...
<div className="col-span-12 xl:col-span-6 2xl:col-span-3 intro-y">
    <div className="report-box- zoom-in- shadow-xl">
        <div className="box p-5 border">
            ...
            <div className="border-green-800 mt-1 border-t-4 pt-2 text-lg">
                กำไรประจำวัน
            </div>
        </div>
    </div>
...
<div className="col-span-12 xl:col-span-6 2xl:col-span-3 intro-y">
    <div className="report-box- zoom-in- shadow-xl">
        <div className="box p-5 border">
            ...
            <div className="border-red-600 mt-1 border-t-4 pt-2 text-lg">
                ยอดถอนประจำวัน
            </div>
        </div>
    </div>
        ...
        <div className="box p-5 border">
            <div className="flex">
                ...
                <div className="ml-auto text-right mb-8">
                    ...
                    <div className="text-4xl font-bold leading-8 my-6">
                        {dataLoading === false ? <span>{formatCurrency(dashboarddata.depositsUserToday)}</span> : spinnerLoad()}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="box p-5 border">
            <div className="flex">
                ...
                <div className="ml-auto text-right mb-8">
                    ...
                    <div className="text-4xl font-bold leading-8 my-6">
                        {dataLoading === false ? <span>{formatCurrency(dashboarddata.depositsCountToday)}</span> : spinnerLoad()}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="box p-5 border">
            <div className="flex">
                ...
                <div className="ml-auto text-right mb-8">
                    ...
                    <div className="text-4xl font-bold leading-8 my-6">
                        {dataLoading === false ? <span>{formatCurrency(dashboarddata.depositsUserYesterday)}</span> : spinnerLoad()}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="box p-5 border">
            <div className="flex">
                ...
                <div className="ml-auto text-right mb-8">
                    ...
                    <div className="text-4xl font-bold leading-8 my-6">
                        {dataLoading === false ? <span>{formatCurrency(dashboarddata.depositsCountYesterday)}</span> : spinnerLoad()}
                    </div>
                </div>
            </div>
        </div>
