...
const MemberList = () => {
    ...
    const getUsers = (page = 1) => {
        axios.get(`${API}/users?limit=20&page=${page}&q=${searchTerm}`, {
            headers: {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`https://apibein.bizboo.com/api/v1/users/register-admin`, {
            "name": accountName,
            "lastName": accountName,
            "phonenumber": phone,
            "pin": pinCode,
            "accountNo": accountNumber,
            "bank": selectAddUser.toLocaleLowerCase(),
            "line": "",
            "ref": remark
        }, {
            headers: {
                                ...
                                <div className="flex flex-col sm:flex-row items-center pt-5 pb-3 mb-3 border-b-2 border-primary">
                                    <h2 className="text-lg font-display mr-auto flex items-center text-neutral-600 uppercase font-bold">
                                        <svg
                                            ...
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            className="feather feather-user w-6 h-6 mr-3 text-blue-800 inline w-6 h-6 mr-3 text-blue-800 inline"
                                        >
                                    ...
                                    <div className="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                                        <button
                                            className="btn bg-green-600 text-white font-display btn btn-md btn bg-green-600 text-white font-display"
                                            type="button"
                                        ...
                                        >
                                            ...
                                            <span className="pl-1">เพิ่มลูกค้า</span>
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <form className="grid grid-cols-12 gap-3 py-3">
                                        <div className="col-span-8 sm:col-span-6 md:col-span-4 xl:col-span-3">
                                            <input
                                                ...
                                                placeholder="ยูสเซอร์เนม, เบอร์โทร, เลขที่บัญชี"
                                        ...
                                        {/* <div className="col-span-8 sm:col-span-6 md:col-span-4 xl:col-span-3">
                                            <div className="py-1 py-0 !h-[38px]">
                                                ...
                                                <div className="errorMessage">
                                                    ...
                                                    >
                                                        ...
                                                        <option value={2}>ฝากเงินแล้ว (Silver)</option>
                                                        <option value={3}>Level2 (Gold)</option>
                                                        <option value={4}>Level3 (Platinum)</option>
                                                    </select>
                                                    <select
                                                    ...
                                                    <div className="ts-control tom-select non-searchable single input-hidden">
                                                        <div className="items ts-input full has-items">
                                                            ...
                                                            <input
                                                                ...
                                                                haspopup="listbox"
                                                                aria-expanded="false"
                                                                aria-controls="tomselect-7-ts-dropdown"
                                                                id="tomselect-7-tomselected"
                                                            />
                                                        </div>
                                                        <div
                                    ...
                                    <table className="w-full text-xs border">
                                        <thead>
                                            <tr className="bg-gray-700 dark:bg-dark-1 text-white font-display text-sm font-semibold">
                                                ...
                                                <th className="py-4 px-6 whitespace-nowrap border text-right">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div className="flex items-center cursor-pointer">
                                                            ...
                                                            >
                                                                <path
                                                                    fill="currentColor"
                                                                    d="M137.4 41.4c12.5-12.5 32.8-12.5 45.3 0l128 128c9.2 9.2 11.9 22.9 6.9 34.9S301 224.1 288 224.1H32c-12.9 0-24.6-7.8-29.6-19.8s-2.2-25.7 6.9-34.9l128-128zm0 429.3l-128-128c-9.2-9.2-11.9-22.9-6.9-34.9S19.1 288 32.1 288H288c12.9 0 24.6 7.8 29.6 19.8s2.2 25.7-6.9 34.9l-128 128c-12.5 12.5-32.8 12.5-45.3 0"
                                                                />
                                                            </svg>
                                            ...
                                            {users && users.map(data => {
                                                return (<tr className="hover:bg-yellow-100 px-half">
                                                    ...
                                                    <td className="py-1 px-2 border number-display text-center">
                                                        <button className={data.flag !== 0 ? "text-white py-0.5 px-1 rounded text-xs min-w-max bg-green-600" : "text-white py-0.5 px-1 rounded text-xs min-w-max bg-red-600"}>
                                                            {data.flag !== 0 ? "ปกติ" : "ระงับ"}
                                                        </button>
                                                    </td>
                                                    <td className="py-1 px-2 border">
                                                        <a
                                                            href={`/member/edit/${data.id}#general`}
                                                    ...
                                                    <td className="py-1 px-2 border">
                                                        <span
                                                            className={data.firstDeposit !== 0 ? "to-gray-300 from-gray-200 bg-gradient-to-t pr-1 rounded text-[10px] font-display mb-1 max-w-min min-w-max flex items-center" : "text-white to-blue-500 from-blue-300 bg-gradient-to-t pr-1 rounded text-[10px] font-display mb-1 max-w-min min-w-max flex items-center"}>
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                width="16px"
                                                                height="16px"
                                                            ...
                                                            {data.firstDeposit !== 0 ? "ฝากเงินแล้ว (Silver)" : "ลูกค้าใหม่"}
                                                        </span>
                                                    ...
                                                    <td className="py-1 px-2 border text-center number-display">
                                                        <div className="w-32">
                                                            <div className="flex gap-1 my-1">
                                                                <div
                                                                    className="p-0.5 lex-shrink-0 flex justify-center items-center shadow h-4 w-4 rounded"
                                                        ...
                                                        <div className="flex justify-center">
                                                            <div className="w-24">
                                                                <span className="block">
                                                                    ...
                                                                    {getCurrentTimeInUTC7(data.createdAt, 14)}
                                                                </span>
                                                                <span className="block text-xs font-light">
                                                                    {formatTimeDifference(new Date(data.createdAt),14)}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td className="py-1 px-2 border text-right number-display w-24">
                                                        {parseFloat(data.firstDeposit)}
                                                    </td>
                                                    <td className="py-1 px-2 border text-right number-display w-36">
                                                        <div className="w-36 pr-3">
                                                            <div>
                                                                ฝาก: <span className="text-green-600">{parseFloat(data.totalDeposit)}</span>
                                                            </div>
                                                            <div>
                                                                ถอน: <span className="text-red-600">{parseFloat(data.totalWithdraw)}</span>
                                                            </div>
                                                            <div>
                                                                ดุล: <span className={parseFloat(data.depositMinusWithdraw) < 0 ? "text-red-600" : "text-green-600"}>{parseFloat(data.depositMinusWithdraw)}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div className="flex justify-center">
                                                            <div className="flex items-center w-36">
                                                                ...
                                                                <button
                                                                    ...
                                                                    type="button"
                                                                    onClick={() => navigate(`/member/edit/${data.id}#general`)}
                                                                >
                                                                    <svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        width="16px"
                        ...
                        <div>
                            <form noValidate="" className="p-5 pb-5" onSubmit={handleSubmit}>
                                ...
                                {/* <div className="flex flex-col mb-3">
                                    <label htmlFor="isActive" className="form-label sm:w-28">
                                        เปิดใช้
                                    </label>
