                            ...
                            <div className="box px-5 pb-5">
                                ...
                                <div className="flex flex-wrap">
                                    <div className="flex flex-col w-full sm:w-80">
                                        <label className="form-label flex mt-1">ช่วงเวลา</label>
                                    ...
                                    <div className="flex flex-col w-full sm:w-40 sm:ml-3">
                                        <div className="py-1">
                                            ...
                                            <div className="errorMessage">
                                                ...
                                                >
                                                    ...
                                                    <option value="done">โอนแล้ว</option>
                                                ...
                                                <div className="ts-control tom-select non-searchable single input-hidden">
                                                    <div className="items ts-input full has-items">
                                                        ...
                                                        <input
                                                            ...
                                                            haspopup="listbox"
                                                            aria-expanded="false"
                                                            aria-controls="tomselect-32-ts-dropdown"
                                                            id="tomselect-32-tomselected"
                                                        />
                                                    </div>
                                                    <div
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 mb-6 gap-3">
                                    <div className="border-l-4 border-blue-600 flex flex-col pl-3">
                                        <span>ยูสใหม่</span>
                                        <div className="flex items-center h-10">
                                            <span className="text-2xl font-semibold">2</span>
                                        </div>
                                    </div>
                                    <div className="border-l-4 border-green-600 flex flex-col pl-3 relative">
                                        <span>ฝากครั้งแรก</span>
                                        <div className="flex items-center h-10">
                                            <span className="text-2xl font-semibold">0</span>
                                        </div>
                                        <span className="absolute right-1 bottom-1 text-xs">(รวม: 0)</span>
                                    </div>
                                    <div className="border-l-4 border-yellow-500 flex flex-col pl-3">
                                        <span>คิดเป็น</span>
                                        <div className="flex items-center h-10">
                                            <span className="text-2xl font-semibold">0.00</span>
                                        </div>
                                    </div>
                                    <div className="border-l-4 border-orange-500 flex flex-col pl-3">
                                        <span>โอนแล้ว</span>
                                        <div className="flex items-center h-10">
                                            <span className="text-2xl font-semibold">0</span>
                                        </div>
                                ...
                                <div className="overflow-x-auto">
                                    <table className="table- w-full text-xs border text-left">
                                        <thead>
                                            <tr className="bg-gray-700 dark:bg-dark-1 text-white px-half font-display text-sm font-semibold">
                                                <th className="py-1 px-2 border whitespace-nowrap text-center">
                                                    #
                                                </th>
                                                <th className="py-1 px-2 border whitespace-nowrap">
                                                    ยูสเซอร์เนม
                                                </th>
                                                <th className="py-1 px-2 border whitespace-nowrap">ชื่อ-สกุล</th>
                                                <th className="py-1 px-2 border whitespace-nowrap text-center">
                                                    บัญชีเงินฝาก/เลขที่บัญชี
                                                </th>
                                                ...
                                                <th className="py-1 px-2 border whitespace-nowrap text-left">
                                                    {" "}
                                                    IP สมัคร
                                                </th>
                                                <th className="py-1 px-2 border whitespace-nowrap text-center">
                                                ...
                                                <th className="py-1 px-2 border whitespace-nowrap"> ผู้แนะนำ</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr className="hover:bg-yellow-100 px-half">
                                                <td className="py-1 px-2 border text-center w-10">
                                                    1 <span className="text-mobile text-gray-500">#1976430</span>
                                                </td>
                                                <td className="py-1 px-2 border">
                                                    <a
                                                        href="/member/edit/1976430#general"
                                                ...
                                                <td className="py-1 px-2 border-b">
                                                    <span className="w-36 block">นาง เสาวณีย์ ฟักทอง</span>
                                                </td>
                                                <td className="py-1 px-2 border number-display w-56">
                                                    <div className="flex items-center text-left pl-1 w-52">
                                                        <div
                                                ...
                                                <td className="py-1 px-2 border text-center number-display w-32">
                                                    <div className="w-24">
                                                ...
                                                <td className="py-1 px-2 border number-display">27.55.71.23</td>
                                                <td className="py-1 px-2 border number-display text-center">
                                                    <button className="text-white py-0.5 px-1 rounded w-20 bg-yellow-500">
                                                        รอโอน
                                                    </button>
                                                </td>
                                                <td className="py-1 px-2 border number-display">เพื่อนแนะนำ</td>
                                                <td className="py-1 px-2 border number-display">
                                                    wgssk1e6c07625
                                                </td>
                                            </tr>
                                            <tr className="hover:bg-yellow-100 px-half">
                                                <td className="py-1 px-2 border text-center w-10">
                                                    2 <span className="text-mobile text-gray-500">#1974245</span>
                                                </td>
                                                <td className="py-1 px-2 border">
                                                    <a
                                                        href="/member/edit/1974245#general"
                                                        className="text-blue-500 underline"
                                                    >
                                                        wgssk1bd0a4f15
                                                    </a>
                                                ...
                                                <td className="py-1 px-2 border-b">
                                                    <span className="w-36 block">น.ส. ชัชฎาภรณ์ เฟื่องฟู</span>
                                                </td>
                                                <td className="py-1 px-2 border number-display w-56">
                                                    <div className="flex items-center text-left pl-1 w-52">
                                                        <div
                                                ...
                                                <td className="py-1 px-2 border number-display">
                                                    2001:44c8:41c8:2cf6:1023:c09a:a754:5c10
                                                </td>
                                                <td className="py-1 px-2 border number-display text-center">
                                                    <button className="text-white py-0.5 px-1 rounded w-20 bg-yellow-500">
                                                        รอโอน
                                                ...
                                                <td className="py-1 px-2 border number-display">Facebook</td>
                                                <td className="py-1 px-2 border number-display" />
                                            </tr>
                                            <tr
                                                ...
                                                style={{ display: "none" }}
                                            >
                                                <td className="py-1 px-2" colSpan={18}>
                                                    ไม่มีข้อมูล
                                                </td>
                                            </tr>
                                            <tr className="px-2" style={{ display: "none" }}>
                                                <td colSpan={18} className="text-center py-1 px-2">
